...
<div class="topnav" id="myTopnav">
 <a href="index.php">Home</a>
  ...
  <a href="aboutus.php">Reports</a>
</div>
<br><br><br>
<div align="center">
<form method="post" action="billing.php">
<h2> IF OLD Customer :-</h2> <input type="text" name="Custid" placeholder="Customer ID">
<br>Add Items by id
...
<br>
<form>
  Check Any Bill Details by Bill no :-<input type="text" name="billno">
